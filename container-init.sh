...
docker exec rt bash -c "cd /usr/local/src/rt-4.4.3; /usr/bin/perl -I/opt/rt4/local/lib -I/opt/rt4/lib sbin/rt-setup-database --action init --dba-password 'rootpass'"
